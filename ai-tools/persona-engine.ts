...
*Generated by AI-Native QA Toolkit — Synthetic Persona Engine*`;
  ...
  const reportPath = saveReport('persona-report.md', report, flags.quiet || flags.json);
...
and writes runs/reports/persona-report.md. Exits with code 1 if any persona fails.
`
  );
