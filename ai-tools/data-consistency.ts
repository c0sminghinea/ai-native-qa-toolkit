...
`;
  ...
  const reportPath = saveReport('data-consistency-report.md', report, flags.quiet || flags.json);
...
falling back to a bundled cal.com preset. Writes runs/reports/data-consistency-report.md
