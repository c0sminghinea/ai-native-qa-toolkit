...
`;
    ...
    const reportPath = saveReport('visual-regression-report.md', report, flags.quiet || flags.json);
...
each with the AI vision model. Writes runs/reports/visual-regression-report.md and exits
